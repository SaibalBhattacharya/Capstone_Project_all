---
title: "Capstone Project - Part 3a"
...
Can Random Forest regression be used to identify features that affect the 4-yr graduation rate?
...
```
#### **Observation:**    
##### Training sample size = 806 while testing sample size = 345.
...
#### **Observation from Run 1 (with default parameters):**
...
#### **Observations:**
##### The lowest error occurs when number of trees = 472 trees
...
#### **Observation:**
##### Total models to be run = 112 

#### **Run loops**
```{r }
#Loop through each hyperparameter combination and apply 500 trees 
#Initial analysis (Run 1) showed that using 500 trees resulted in a stable error rate
...
##### Best performing models: node_size = 3-7 observations in terminal node (i.e., with deeper trees), mtry = 22, and sample size = 0.8 
...
#### **Observation:**
##### Expected error ranges between ~ 9.35-9.48% with a most likely of 9.42%

#### **Plot histogram of 4-yr grad rate (to put in prespective the above calculated error range)**
```{r }
...
#### **Observation:**
##### The 4-yr graduation rate varies from zero to 90% with most frequent being between 20 to 30%.
##### The most frequent error in predicting this graduation rate is around 9.4%.  
...
#### **Observation:**
##### Expected error ranges between ~9.6 to 9.8% with a most likely of 9.7%.
...
#Use rownames to fill in a new column call names
...
#### **Observation:**
##### Five most important parameters that affect the 4-yr graduation rate are:
#####   1. Percent 1-yr undergraduates who have Pell grant
#####   2. Percent 1-yr undergraduates who have Federal grant
#####   3. Total price of out-of-state in 2013-14
#####   4. Tuition 2010-11
#####   5. Tuition 2013-14